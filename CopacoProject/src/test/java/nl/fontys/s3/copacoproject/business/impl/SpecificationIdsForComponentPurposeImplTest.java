...
//        Map<Object, List<String>> expectedMap = new HashMap<>();
//        expectedMap.put(null, List.of("Server"));
//        Map<Object, List<String>> expectedMap2 = new HashMap<>();
//        expectedMap.put(null, List.of("Workstation"));
//
//        assertEquals(expectedMap, specificationIdsForComponentPurpose.getSpecificationIdAndValuesForComponentPurpose("Server", 1L));
//        assertEquals(expectedMap2, specificationIdsForComponentPurpose.getSpecificationIdAndValuesForComponentPurpose("PC", 1L));
//        assertEquals(expectedMap2, specificationIdsForComponentPurpose.getSpecificationIdAndValuesForComponentPurpose("Workstation", 1L));
...
//        assertEquals(Map.of(954L, List.of("Liquid cooling kit", "Heatsink", "Radiatior", "Air cooler", "Radiator block", "Cooler", "All-in-one liquid cooler")), specificationIdsForComponentPurpose.getSpecificationIdAndValuesForComponentPurpose("PC", 8L));
...
//        assertEquals(1070L, specificationIdsForComponentPurpose.getTheSpecificationIdWhereTheDifferentConfigurationTypesCanBeFoundForCategory(3L));
//    }
//
//    @Test
//    void testGetAllDistinctSpecificationIdsThatHoldConfigurationType() {
//        List<Long> expectedSpecificationIds = List.of(947L, 954L, 1070L, 1792L);
