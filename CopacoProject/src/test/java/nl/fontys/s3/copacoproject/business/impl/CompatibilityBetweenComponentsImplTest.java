//Tests are fialing because of the environemnt variables
...
//
//        when(componentRepository.findComponentsBySpecificationsNative(null,120.0,null,typeOfConfigurationPC,null,10.0,pageableFirstPage)).thenReturn(listOf10PSUs);
//        when(componentRepository.findComponentsBySpecificationsNative(null,120.0,null,typeOfConfigurationPC,null,10.0,pageableCheckNextPage)).thenReturn(List.of());
//
//        List<GetAutomaticCompatibilityResponse> actualResponse = compatibilityBetweenComponents.automaticCompatibility(requestWithMaxProvidedComponentsAndLastSearchedPSU2);
